...
vuln('listening-shell', [], [reverse_shell], [], 1, 1).
vuln('reverse-shell', [reverse_shell], [root_shell], [lamp-[]], 1, 2).
...
% vuln('exec-custom-php', [php_webapp, web_admin_access], [user_shell], [], 1, 1).
...
% vuln('custom-PATH-setuid', [user_shell, setuid_binary, assumed_PATH_var], [root_shell], [], 1, 1).
